...
- **FR-015**: 每封 Email MUST 包含：Lesson 標題、Lesson 全文內容（html_content）、連回網站的連結、退訂連結。若 Lesson 包含影片，MUST 以加大粗體紅色樣式顯示提示「本課程包含教學影片，請至網站觀看」以及「影片 48 小時內免費觀看，把握時間！」免費觀看期提示。若 Lesson 無文字內容（純影片），MUST 顯示預設文案引導使用者前往網站。
