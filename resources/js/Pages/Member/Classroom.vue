      ...
      <main class="flex-1 overflow-y-auto">
        <div class="max-w-5xl mx-auto p-4 lg:p-8">
          ...
          >
            ...
            <h2 class="text-xl font-semibold text-gray-900 mb-2">領取成功！</h2>
            <p class="text-gray-500">第一封內容即將發送至您的信箱，請留意 Email 通知。</p>
          </div>
          ...
          <div v-else-if="selectedLesson">
            ...
            <template v-if="selectedLesson.has_video">
              ...
              <!-- HTML Content -->
              <div v-if="selectedLesson.content_md">
                <HtmlContent :content="selectedLesson.content_md" />
              </div>
            </template>
            ...
            <div
              v-if="!selectedLesson.has_video && !selectedLesson.content_md"
