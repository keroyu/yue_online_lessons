...
// Homepage "所有資源" block. The content-category buttons are this block's
// header, not a widget of their own: they filter the grid directly below them,
// so the two can never be reordered apart (002 FR-075).
