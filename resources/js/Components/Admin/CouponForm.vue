  ...
  <form @submit.prevent="submit" class="space-y-6 bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl p-6">
    ...
    <div>
      ...
      <input
        ...
        maxlength="6"
        :disabled="isEdit"
        class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm uppercase focus:border-brand-teal focus:ring-1 focus:ring-brand-teal outline-none disabled:bg-gray-100 disabled:text-gray-500"
    ...
    <!-- 啟用 -->
    <label class="flex items-center gap-2 text-sm">
      <input type="checkbox" v-model="form.is_active" class="rounded text-brand-teal" /> 啟用此折扣碼
    </label>
