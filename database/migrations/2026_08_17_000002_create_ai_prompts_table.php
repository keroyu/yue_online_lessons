    ...
    private static function prompts(): array
    {
        return [
            ...
            [
                ...
                'feature'           => 'consultation',
                'label'             => '面談摘要',
                'description'       => '以校訂後的逐字稿與客戶暱稱為輸入，產生固定結構的客戶摘要，供顧問內部判讀。追銷信自 011 US35 起改由 consultation_followup_email 另外產生。',
                'instructions'      => self::summaryInstructions(),
                'model'             => null,
                // Back to 2000: US29 raised it to 4000 only to make room for the
                // follow-up letter, which now has a prompt of its own (FR-187).
...
逐字稿前面可能有一行「客戶暱稱：某某」，那是這位客戶登記的稱呼，可在需要指稱對方時使用；它不是對話內容，不要摘要它。
