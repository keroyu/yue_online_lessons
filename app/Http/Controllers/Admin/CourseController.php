    ...
    public function index(): Response
    {
        $courses = Course::withTrashed()
            ...
            ->map(fn ($course) => [
                ...
                'promo_ends_at' => $course->promo_ends_at?->timezone('Asia/Taipei')->format('Y-m-d H:i'),
                'is_promo_active' => $course->is_promo_active,
                'thumbnail' => $course->thumbnail,
                'sale_at' => $course->sale_at?->timezone('Asia/Taipei')->format('Y-m-d H:i'),
    ...
    public function edit(Course $course): Response
    {
        ...
        return Inertia::render('Admin/Courses/Edit', [
            'course' => [
                ...
                'price' => $course->price,
                'original_price' => $course->original_price,
                'promo_ends_at' => $course->promo_ends_at?->timezone('Asia/Taipei')->format('Y-m-d\TH:i'),
                'is_promo_active' => $course->is_promo_active,
                'thumbnail' => $course->thumbnail,
                'instructor_name' => $course->instructor_name,
                'product_type' => $course->type,
                ...
                'status' => $course->status,
                'is_published' => $course->is_published,
                'sale_at' => $course->sale_at?->timezone('Asia/Taipei')->format('Y-m-d\TH:i'),
